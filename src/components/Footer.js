...
export default function Footer() {
  return (
      <footer className=" grid grid-cols-2 md:grid-cols-3 gap-4 justify-between py-12 md:py-24  px-8 md:px-16 bg-gray-700">
        <div className="flex flex-col max-w-xs gap-5">
          <h2 className="text-xl font-bold text-white">My Job Seeker</h2>
